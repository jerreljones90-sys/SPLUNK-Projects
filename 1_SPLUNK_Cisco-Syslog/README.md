...
1. Shut down SVI VLAN 700 on the Cisco Layer 3 switch to generate an interface down syslog event.
2. Bring VLAN 700 back up to generate the corresponding interface up event.
3. Use Wireshark to verify that UDP/514 syslog traffic is being transmitted across the network.
4. Search the received events in Splunk Enterprise to confirm successful log ingestion.
